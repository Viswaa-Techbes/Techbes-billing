  ...
  return (
    <div className="space-y-6 text-slate-800">
      <PageHeader
        ...
        subtitle="Manage billing transactions, tax invoices, and outstanding customer balances."
      />
      <div className="card-panel p-16 rounded-xl text-center space-y-4 max-w-2xl mx-auto">
        ...
        <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
          Sales Invoices management is part of the subsequent developmental stages. In the current stage, please focus on managing Clients & Prospects and Quotation & Estimates.
        </p>
      </div>
    </div>
  );

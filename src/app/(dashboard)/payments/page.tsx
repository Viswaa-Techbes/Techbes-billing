  ...
  return (
    <div className="space-y-6 text-slate-800">
      <PageHeader
        ...
        subtitle="Record payments received from clients against outstanding invoices."
      />
      <div className="card-panel p-16 rounded-xl text-center space-y-4 max-w-2xl mx-auto">
        ...
        <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
          Payment Receipts management is part of the subsequent developmental stages. In the current stage, please focus on managing Clients & Prospects and Quotation & Estimates.
        </p>
      </div>
    </div>
  );

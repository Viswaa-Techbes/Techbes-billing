...
export default function CreditNotesListPage() {
  ...
  return (
    <div className="space-y-6 text-slate-800">
      <PageHeader
        title="Credit Notes"
        subtitle="Manage product returns, discount offers, fault credits, and client balance settlements."
        actions={
          <Link
      ...
      {/* Filters Toolbar */}
      <div className="card-panel p-4 rounded-xl bg-white shadow-sm border border-slate-200 flex flex-col md:flex-row gap-4 items-center">
        ...
        <div className="w-full md:w-48">
          <select
            ...
            className="w-full form-input text-xs text-slate-700 bg-white"
          >
      ...
      {loading ? (
        ...
        <div className="card-panel p-16 rounded-xl flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-sm font-bold text-slate-700">No Credit Notes found</h3>

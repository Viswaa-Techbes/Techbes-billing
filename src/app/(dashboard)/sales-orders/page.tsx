...
export default function SalesOrdersListPage() {
  ...
  return (
    <div className="space-y-6 text-slate-800">
      <PageHeader
        title="Sales Orders"
        subtitle="Manage client sales purchase confirmations and order processing workflows."
        actions={
          <Link
      ...
      {/* Filter Toolbar */}
      <div className="card-panel p-4 rounded-xl bg-white shadow-sm border border-slate-200 flex items-center justify-between">
      ...
      {loading ? (
        ...
        <div className="card-panel p-16 rounded-xl flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-sm font-bold text-slate-700">No Sales Orders found</h3>
          <p className="text-slate-450 text-xs mt-1 max-w-sm">
            Generate and track confirmed purchase orders, convert them directly to Tax Invoices, and monitor fulfillment pipelines.
          </p>
          <Link
            href="/sales-orders/new"

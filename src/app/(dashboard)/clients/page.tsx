  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        subtitle="Manage information, billing references, and records for your business partners."
        actions={
          <Link 
            href="/clients/new" 
      ...
      <div className="border-b border-slate-200 flex gap-6 text-sm">
        <button
          ...
          className={`pb-3 font-semibold relative transition-colors ${
            activeTab === 'ACTIVE' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-900'
          }`}
        >
          Active Clients
          {activeTab === 'ACTIVE' && (
        ...
        <button
          ...
          className={`pb-3 font-semibold relative transition-colors ${
            activeTab === 'INACTIVE' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-900'
          }`}
        >
          Inactive Clients
          {activeTab === 'INACTIVE' && (
      ...
      {/* Client Toolbar */}
      <div className="card-panel p-4 rounded-xl flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
          ...
          <input
            ...
            className="form-input text-xs w-full md:w-36 py-2 text-slate-900 placeholder:text-slate-400"
          />
      ...
      {loading ? (
        ...
        <div className="card-panel p-16 rounded-xl flex flex-col items-center justify-center text-center">
          ...
          <Link
            href="/clients/new"
            className="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-750 text-white rounded-lg text-xs font-semibold shadow-sm transition-colors"
          >
            + Add Client
          </Link>
        </div>

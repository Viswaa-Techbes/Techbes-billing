      ...
      <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto bg-white">
        ...
        <div className="space-y-1">
          <button
            ...
            className={`w-full flex items-center justify-between px-4 py-2.5 rounded-xl transition-all duration-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900`}
          >
          ...
          {/* Sub menu list */}
          <div
            className={`pl-8 pr-2 space-y-1 transition-all duration-200 overflow-hidden ${
              isSalesExpanded ? 'max-h-[400px] opacity-100 py-1' : 'max-h-0 opacity-0 pointer-events-none'
            }`}
          >
      ...
      <div className="p-4 border-t border-slate-100 bg-white">
        <div className="p-3 bg-slate-50 rounded-xl border border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-slate-700">TechBes Billing</span>
          </div>
          <p className="text-[10px] text-slate-400 mt-0.5">Sales & Quotations Mode</p>
        </div>
      </div>
    </aside>
  );
